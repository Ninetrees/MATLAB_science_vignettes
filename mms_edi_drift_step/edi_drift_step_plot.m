...
% 	disp 'entering edi_drift_step_plot'
	...
	GDU_planeInBPP = DMPA2BPP * virtual_instr_plane; % instrument plane rotated into BPP
...
% 		GrubbsBeamInterceptMean, GrubbsBeamInterceptStdDev, GrubbsBeamInterceptMean_stdDev) )
	...
	virtualSource_bpp = [ GrubbsBeamInterceptMean; 0.0 ];
	if show_unit_vectors
		...
		virtualSource_bpp_u = virtualSource_bpp / norm (virtualSource_bpp, 2);
...
% size (p)
	...
	virtualSource_bpp_angle = atan2d (virtualSource_bpp(2), virtualSource_bpp(1));
